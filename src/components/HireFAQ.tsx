...
export default function HireFAQ() {
    ...
    return (
        <section 
            ...
            aria-labelledby="hire-faq-title"
        >
            {/* Header Block */}
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    <h2 id="hire-faq-title" className="text-lg font-extrabold text-gray-900 tracking-tight">
                        Hiring & Engagement Conditions
                    </h2>
                    <p className="text-xs text-gray-400 mt-0.5 font-medium">
                        Information regarding project boarding speeds, turnaround guidelines, and engineering agreements.
                    </p>
                </div>
            </div>
