...
import type { PageSectionItem, ProcessCard, ProcessLayoutStyle } from '../types';
...
export const ProcessView: React.FC<{
  ...
  const paddingClass =
    sec.paddingSize === 'sm' ? 'py-6 px-6' : sec.paddingSize === 'lg' ? 'py-16 px-6' : 'py-10 px-6';
  ...
  return (
    ...
    <div className={`w-full ${themeClass}`}>
      ...
      <div className={`max-w-5xl mx-auto space-y-10 ${paddingClass}`}>
...
//   return (
//     <div className={`mx-auto space-y-10 ${paddingClass} ${themeClass}`}>
//       <div className="text-center space-y-3 max-w-2xl mx-auto">
//         <EditableText
//           as="h2"
//           value={sec.title || ''}
